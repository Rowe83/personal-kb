...
- **清爽文档风 UI**：统一浅色主题，强调色 `#1D4E89`；首页状态卡片、侧栏品牌
- **批量导入进度**：逐文件进度条 + 当前文件名；结束后展示成功/跳过/失败汇总
- **文档删除**：知识库列表逐条删除（二次确认），自动刷新 BM25 与 uploads
...
- **首页** — 使用说明与路线图
- **💬 对话** — 基于知识库的流式问答
- **📚 知识库** — 上传 PDF/TXT/MD/XLSX（支持批量、逐文件进度）、查看与删除已入库文档
